...
interface EmotionalRegisterProps {
  onNavigateToMindset?: () => void
}

export const EmotionalRegister: React.FC<EmotionalRegisterProps> = ({ onNavigateToMindset }) => {
  ...
  // Se activa si el estado de ánimo es bajo o si eligió etiquetas de frustración / estrés
  const isOverwhelmed = selectedMood === 'mal' || selectedMood === 'muy_mal' || selectedTags.includes('Frustración') || selectedTags.includes('Estrés')
  ...
  return (
    <div className="w-full max-w-xl mx-auto py-4 md:py-6 space-y-6">
      {step === 1 && (
      ...
      {step === 4 && (
        <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-xs space-y-4">
          ...
          {/* Banner de redirección a MindsetGuide cuando hay frustración o bajo ánimo */}
          {isOverwhelmed && (
            <div className="bg-gradient-to-r from-rose-500 to-purple-600 text-white rounded-2xl p-4 shadow-md space-y-2.5 text-center">
